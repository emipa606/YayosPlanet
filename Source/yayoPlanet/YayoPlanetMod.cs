...
public class YayoPlanetMod : Mod
{
    ...
    public override void DoSettingsWindowContents(Rect rect)
    {
        ...
        listing.CheckboxLabeled(
            "bl_randomType_t".Translate(),
            ref Settings.bl_randomType);

        // -------- yyCold checkbox --------
        listing.CheckboxLabeled(
            "bl_yyCold_t".Translate(),
            ref Settings.bl_yyCold);
        ...
        // -------- val_yyCold slider --------
        {
            ...
            Widgets.Label(left, "val_yyCold_t".Translate());
        ...
        // -------- yyHot checkbox --------
        listing.CheckboxLabeled(
            "bl_yyHot_t".Translate(),
            ref Settings.bl_yyHot);
        ...
        // -------- val_yyHot slider --------
        {
            ...
            Rect left = row.LeftPart(0.45f).Rounded();
            Rect right = row.RightPart(0.55f).Rounded();
            Widgets.Label(left, "val_yyHot_t".Translate());
        ...
        // -------- yyTornado checkbox --------
        listing.CheckboxLabeled(
            "bl_yyTornado_t".Translate(),
            ref Settings.bl_yyTornado);
        ...
        // -------- val_yyTornado slider --------
        {
            ...
            Rect left = row.LeftPart(0.45f).Rounded();
            Rect right = row.RightPart(0.55f).Rounded();
            Widgets.Label(left, "val_yyTornado_t".Translate());
        ...
        // -------- val_threat slider (with tooltip) --------
        {
            ...
            Rect left = row.LeftPart(0.45f).Rounded();
            Rect right = row.RightPart(0.55f).Rounded();
            Widgets.Label(left, "val_threat_t".Translate());
            if (Mouse.IsOver(row)) TooltipHandler.TipRegion(row, "val_threat_d".Translate());
    ...
    public override string SettingsCategory() => "YP_ModName".Translate();
}
