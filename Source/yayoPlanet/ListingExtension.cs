...
namespace yayoPlanet
{
    ...
    {      
        ...
        public static void IntEntryWithAdjuster(this Listing_Standard listing, string key, ref int value, int step, int min, int max)
        {
            ...
            // Label
            Widgets.Label(labelRect, key.Translate());            
